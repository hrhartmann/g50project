...
class CampusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campu" do
    assert_difference('Campu.count') do
      post campus_url, params: { campu: { nombre: @campu.nombre, ubicacion: @campu.ubicacion } }
    end
  ...
  test "should update campu" do
    patch campu_url(@campu), params: { campu: { nombre: @campu.nombre, ubicacion: @campu.ubicacion } }
